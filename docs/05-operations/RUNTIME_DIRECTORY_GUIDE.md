...
1. 程序目录只放安装包内容
2. `%LocalAppData%\UniversalTrayTool` 放所有可变运行时数据
...
- `%LocalAppData%\UniversalTrayTool`
...
1. `%LocalAppData%\UniversalTrayTool\appsettings.json`
2. `%LocalAppData%\UniversalTrayTool\logs`
3. `%LocalAppData%\UniversalTrayTool\plugins`
4. `%LocalAppData%\UniversalTrayTool\release-staging\plugins`
